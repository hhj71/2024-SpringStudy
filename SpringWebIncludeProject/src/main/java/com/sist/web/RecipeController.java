...
public class RecipeController {
   ...
   // recipe/find.do => URL이라면 => 조건문 : 어노테이션 ==> if문의 역할 ==> 찾기 기능 
   @RequestMapping("recipe/find.do")  // RequestMapping -> GET/POST 방식 동시에 작동 가능
//   													     => 검색에서 페이지 나누는 경우 
   public String recipe_find(String fd, String page, Model model) // fd => 사용자가 보낸 데이터 / model => 전송할 데이터
   {
	   if(fd==null)
		   fd="감자";
	   if(page==null)
