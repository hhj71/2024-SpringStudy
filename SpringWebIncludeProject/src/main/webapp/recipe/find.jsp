...
<body>
   ...
   <div class="row">
     <div class="text-center">
         <a href="../recipe/find.do?fd=${fd }&page=${curpage>1?curpage-1:curpage}" class="btn-sm btn-info">이전</a>
			${curpage } page / ${totalpage } pages
        <a href="../recipe/find.do?fd=${fd }&page=${curpage<totalpage?curpage+1:curpage}" class="btn-sm btn-info">다음</a>
     </div>
   </div>
</body>
</html>